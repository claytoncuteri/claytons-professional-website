...
const aiMlQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "In the mod-guard ensemble pipeline, why does the rule-based classifier receive the same weight (0.4) as the toxicity model?",
    options: [
...
const projectQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "In the mod-guard ensemble classifier, what happens when the toxicity layer is disabled (enable_toxicity=False)?",
    options: [
  ...
  },
  {
    ...
    type: "open_ended",
    question:
      "Explain why the mod-guard ensemble uses a weighted average rather than a majority vote or max-score approach.",
    explanation:
  ...
  },
  {
    ...
    type: "multiple_choice",
    question:
      "If you narrow the gap between approve_below and reject_above in the mod-guard ThresholdConfig (e.g., changing from 0.3/0.7 to 0.4/0.6), what is the primary effect?",
    options: [
  ...
  },
  {
    ...
    type: "scenario",
    question:
      "You are deploying mod-guard for a children's educational platform. The current thresholds (approve_below=0.3, reject_above=0.7) were tuned for a general audience. How do you adjust them, and what tradeoffs do you accept?",
    explanation:
...
export const STUDY_GUIDE_CATEGORIES: QuizCategory[] = [
  ...
  },
  {
    ...
    description:
      "Architecture decisions, implementation details, and technical tradeoffs from real projects (rag-core, mod-guard). Expect interviewers to probe your actual code.",
    icon: "Code",
